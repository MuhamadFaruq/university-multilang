...
- Name: admin-workflow.spec.ts >> Admin Workflow - Language Management >> Should delete a language from admin interface
- Location: tests/e2e/admin-workflow.spec.ts:26:7
